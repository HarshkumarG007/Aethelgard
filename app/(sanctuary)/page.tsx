...
import { SanctuaryViewSwitch } from "@/components/sanctuary/3d/SanctuaryViewSwitch";
...
export default async function SanctuaryOverviewPage() {
  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      {/* Sanctuary View Switch (2D Baseline + Optional 3D + Independent Semantic DOM) */}
      <SanctuaryViewSwitch memories={allMemories} chapters={chapters}>
